...
PARAM(double,MEC_cm_direction_pp,0.77)\
PARAM(int,MEC_cm_strength_pp,4)\
PARAM(double,MEC_cm_direction_np,0.7)\
PARAM(int,MEC_cm_strength_np,3)\
PARAM(double,MEC_cm_direction_pn,0.8)\
PARAM(int,MEC_cm_strength_pn,4)\
...
PARAM(double,kaskada_NN_mfp_scale,0.76)\
