...
$(BIN)/nuwro:   $(addprefix src/,\
        pauli.o cohevent2.o cohdynamics2.o qelevent1.o ab_initio_event.o hypevent.o hyperon_interaction.o hyperon_cascade.o lepevent.o nu_e_el_sigma.o\
        ...
        nuwro.o beam.o nd280stats.o beamHist.o coh.o fsi.o pitab.o scatter.o kaskada7.o shell_sampler.o Interaction.o input_data.o data_container.o  main.o) \
        $(EVENT_OBJS) $(SF_OBJS) $(DIS_OBJS) $(MEC_OBJS) $(ESPP_OBJS) $(HYBRID_OBJS)
		$(LINK.cc) $^ -o $@


$(BIN)/kaskada:  $(addprefix src/,\
        scatter.o kaskada7.o shell_sampler.o Interaction.o input_data.o data_container.o hyperon_cascade.o rew/rewparams.o\
...
$(BIN)/fsi: src/scatter.o src/kaskada7.o src/shell_sampler.o src/Interaction.o src/input_data.o src/data_container.o src/nucleus.o  src/nucleus_data.o src/isotopes.o src/elements.o\
...
$(BIN)/niwg: src/scatter.o src/generatormt.o src/kaskada7.o src/shell_sampler.o src/Interaction.o src/input_data.o src/data_container.o  src/nucleus.o  src/nucleus_data.o src/isotopes.o src/elements.o\
...
$(BIN)/ganalysis: $(addprefix src/, \
	event1.o event1Dict.o generatormt.o particle.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o ab_initio_event.o mecdynamics.o mecevent.o hypevent.o hyperon_interaction.o hyperon_cascade.o lepevent.o\
	mecdynamics2.o mecevent2.o mecevent_tem.o mecevent_Nieves.o mecevent_SuSA.o mecevent_common.o rew/PythiaQuiet.o\
        ...
        nuwro.o beam.o nd280stats.o beamHist.o coh.o fsi.o pitab.o scatter.o kaskada7.o shell_sampler.o Interaction.o input_data.o data_container.o ganalysis.o rew/rewparams.o) \
        $(EVENT_OBJS) $(SF_OBJS) $(DIS_OBJS) $(MEC_OBJS) $(ESPP_OBJS) $(HYBRID_OBJS)
		$(LINK.cc) $^ -o $@

$(BIN)/reweight_to: $(addprefix src/, \
	nuwro.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o ab_initio_event.o hypevent.o hyperon_interaction.o hyperon_cascade.o lepevent.o nu_e_el_sigma.o\
        ...
        beam.o nd280stats.o beamHist.o coh.o fsi.o pitab.o scatter.o kaskada7.o shell_sampler.o Interaction.o input_data.o data_container.o\
...
$(BIN)/reweight_along: $(addprefix src/, \
	event1.o event1Dict.o generatormt.o particle.o pauli.o cohevent2.o cohdynamics2.o qelevent1.o ab_initio_event.o mecdynamics.o mecevent.o hypevent.o hyperon_interaction.o hyperon_cascade.o lepevent.o nu_e_el_sigma.o\
	mecdynamics2.o mecevent2.o mecevent_tem.o mecevent_Nieves.o mecevent_2020Valencia.o mecevent_SuSA.o mecevent_common.o\
        qel_sigma.o kinsolver.o kinematics.o pdg.o target_mixer.o nucleus.o  sfevent.o ff.o dirs.o rpa_2013.o nucleus_data.o isotopes.o elements.o \
        nuwro.o beam.o nd280stats.o beamHist.o coh.o fsi.o pitab.o scatter.o kaskada7.o shell_sampler.o Interaction.o input_data.o data_container.o\
